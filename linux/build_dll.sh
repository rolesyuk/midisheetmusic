...
# Script to build SheetMusic.dll from the command prompt.
...
gmcs -res:NotePair.ico,MidiSheetMusic.NotePair.ico \
 ...
 TimeSigSymbol.cs LyricSymbol.cs

gmcs -target:exe ExampleSheetMusicDLL.cs -reference:SheetMusic.dll -reference:System.Drawing,System.Windows.Forms
